...
def main():
    try:
        # Membaca file client_secret.json yang kamu download dari Google Cloud Console
        ...
        print("Pastikan kamu sudah menaruh file 'client_secret.json' di folder yang sama dengan skrip ini.\n")
